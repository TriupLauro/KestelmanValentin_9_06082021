            ...
            <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input type="text" class="form-control blue-border" data-testid="expense-name" placeholder="Vol Paris Londres" id="expense-name"/>
                  </div>
                  <div class="col-half">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="number" class="form-control blue-border input-icon input-icon-right" data-testid="amount" placeholder="348" id="amount"/>
                  </div>
                  <div class="col-half-row">
                    <div class="flex-col"> 
                      <label for="vat" class="bold-label">TVA</label>
                      <input type="number" class="form-control blue-border" data-testid="vat" placeholder="70" id="vat" />
                    </div>
                    <div class="flex-col">
                ...
                <div class="col-md-6">
                  <div class="col-half">
                    ...
                    <textarea class="form-control blue-border" data-testid="commentary" rows="3" id="commentary"></textarea>
                  </div>
                  <div class="col-half">
                    <label for="file" class="bold-label">Justificatif</label>
                    <input required type="file" class="form-control blue-border" data-testid="file" id="file" />
                    <div class="file-error">Les formats d'image .jpg .jpeg ou .png sont les seuls acceptés</div>
                  </div>
                </div>
            </div>
            <div class="row">
